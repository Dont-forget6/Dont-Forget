package com.test.dontforget.UI.TodoDetailPersonalFragment
...
import com.test.dontforget.MainActivity.Companion.TODO_DETAIL_PERSONAL_FRAGMENT
...
import com.test.dontforget.databinding.FragmentTodoDetailPersonalBinding
...
class TodoDetailPersonalFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        fragmentTodoDetailPersonalBinding.run {
            ...
            buttonTodoDetailPersonalRoute.setOnClickListener {

                if(textViewTodoDetailPersonalLocation.text == "위치 없음") {
                ...
                if (ContextCompat.checkSelfPermission(requireContext(), locationPermission) == PackageManager.PERMISSION_GRANTED) {
                    ...
                    val snackbar: Snackbar = Snackbar.make(fragmentTodoDetailPersonalBinding.root, "위치 권한 허용 후 다시 길찾기를 실행해주세요.", Snackbar.LENGTH_INDEFINITE)
