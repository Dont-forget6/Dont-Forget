package com.test.dontforget.UI.MainFriendsFragment
...
import com.test.dontforget.databinding.DialogMainFriendsBinding
import com.test.dontforget.databinding.FragmentMainFriendsBinding
                    ...
                    when (it.itemId) {
                        ...
                        R.id.item_menuMainFriend_add -> {
                            ...
                            builder.setPositiveButton("확인") { dialogInterface: DialogInterface, i: Int ->
                                ...
                                // 자신의 이메일 경우에는 추가하지 않게 변경
                                if(joinFriendReceiverEmail!=MyApplication.loginedUserInfo.userEmail){
                                    // 이미 친구인 경우
                                    // 1. toast 메시지 발생
                                    ...
                                    Toast.makeText(mainActivity, "자신은 친구로 추가할 수 없습니다.", Toast.LENGTH_SHORT).show()
                                }
