package com.test.dontforget.UI.TodoDetailPublicOwnerFragment
...
import com.test.dontforget.MainActivity.Companion.TODO_DETAIL_PUBLIC_OWNER_FRAGMENT
...
import com.test.dontforget.databinding.FragmentTodoDetailPublicOwnerBinding
        ...
        fragmentTodoDetailPublicOwnerBinding.run {
            ...
            buttonTodoDetailPublicOwnerRoute.setOnClickListener {
                ...
                if (ContextCompat.checkSelfPermission(requireContext(), locationPermission) == PackageManager.PERMISSION_GRANTED) {
                    ...
                    val snackbar: Snackbar = Snackbar.make(fragmentTodoDetailPublicOwnerBinding.root, "위치 권한 허용 후 다시 길찾기를 실행해주세요.", Snackbar.LENGTH_INDEFINITE)
